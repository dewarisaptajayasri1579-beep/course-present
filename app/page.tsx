...
export default function AgenticPage() {
  ...
  return (
    <div className="bg-[#F5F4F0] text-[#111] min-h-screen font-sans antialiased">
      ...
      {/* Floating Action Button for Workshop Registration */}
      <a href="/id/register" className="fixed bottom-8 right-8 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-4 rounded-full shadow-[0_0_20px_rgba(79,70,229,0.5)] flex items-center gap-3 transition-transform hover:scale-105 z-50 group font-inter">
        <span className="font-semibold tracking-wide">Masuk ke Workshop</span>
